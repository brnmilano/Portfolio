  ...
  render() {
    return (
      <Html lang="pt-br">
        ...
        <body>
          <noscript dangerouslySetInnerHTML={{ __html: '<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P346378" height="0" width="0" style="display:none;visibility:hidden"></iframe>' }}></noscript>
